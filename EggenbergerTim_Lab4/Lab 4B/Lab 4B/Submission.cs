...
namespace FSPG1
{
    class Submission
    {
        ...
        */
        ...
        {
            if ((fahrenheit - 32) * (5.0 / 9.0) == celsius || (celsius * 9.0 / 5.0) + 32.0 == fahrenheit) { return true; }
        ...
        public static char Test3(double grade)
        {
            ...
            else if(grade >= 73 && grade< 80 ){ return 'C';}
            else if (grade >= 70 && grade < 73) { return 'D'; }
            else if (grade >= 0 && grade < 70) { return 'F'; }
            else { return '?'; } 
        ...
        {
            if(speed <= 5) { return 0; }
            if(speed > 5 && speed <= 10) { return 1; }
            if(speed > 10 && speed <= 25) { return 2; }
            else { return 3; }
        ...
        public static bool Test6(Point p1, Point p2)
        {
            ...
            bool test6 = Equals(p1, p2);
            if (test6) { return true; }
            else { return false; }
        }
        ...
        {
            if (price * taxRate + price < cashOnHand)
            {
                return true;
            }
            else { return false; }
        ...
        {
            if(miles * 1.609 > kilometers) { return miles; }
